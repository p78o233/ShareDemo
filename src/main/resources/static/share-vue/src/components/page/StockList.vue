<template>
    <div>
        ...
        <div class="handle-box">
            ...
            <el-button plain icon="el-icon-plus">创建新的观察数据</el-button>
        </div>
        <!--筛选条件结束-->
        <el-divider></el-divider>
        <!--表格开始-->
        ...
        >
            ...
            <el-table-column label="操作" width="180" align="center">
                <template slot-scope="scope">
                    <el-button type="text" icon="el-icon-edit" @click="lookTimeTask(scope.row)">修改</el-button>
        ...
        <el-dialog
            ...
            <el-form ref="ioeStockForm" :model="ioeStockData" label-width="80px">
                <el-form-item label="股票编号">
                    <el-input v-model="ioeStockData.stockNum"></el-input>
                </el-form-item>
                <el-form-item label="股票名称">
                    <el-input v-model="ioeStockData.stockName"></el-input>
                </el-form-item>
            ...
            <el-button @click="ioeStockVisible = false">取 消</el-button>
            <el-button type="primary" @click="ioeStockVisible = false">确 定</el-button>
            </span>
        </el-dialog>
        <!--新增修改观察数据结束-->
    </div>
